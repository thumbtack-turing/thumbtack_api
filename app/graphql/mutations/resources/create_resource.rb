module Mutations
    module Resources
      class CreateResource < GraphQL::Schema::Mutation
        ...
        rescue MetaInspector::RequestError => _e
          GraphQL::ExecutionError.new("Invalid url.")
        rescue MetaInspector::TimeoutError => e
          GraphQL::ExecutionError.new("Url cannot be reached.")
        end
